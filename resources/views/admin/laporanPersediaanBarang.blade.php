...
<form style="padding: 2%" method="POST">
        ...
        <div class="form-group">
            <input type="button" class="btn btn-primary" onclick="printDiv('printLaporanPersediaanBarang')" value="Print" /><br>
        </div>
  </form>

  <div id="printLaporanPersediaanBarang" style="display:none;">
...
<script>
    ...
    function printDiv(divName) {
        document.getElementById('printLaporanPersediaanBarang').style.display = "block";
        var printContents = document.getElementById(divName).innerHTML;
        var originalContents = document.body.innerHTML;
        document.body.innerHTML = printContents;
        window.print();
        document.body.innerHTML = originalContents;
        document.getElementById('printLaporanPersediaanBarang').style.display = "none";
    }
</script>
@endsection
