...
<form style="padding: 2%" method="POST">
        ...
        <div class="form-group">
            <input type="button" class="btn btn-primary" onclick="printDiv('printLaporanReturPembelian')" value="Print" /><br>
        </div>
  </form>

  <div id="printLaporanReturPembelian" style="display:none;">
...
<script>
    ...
    function printDiv(divName) {
        document.getElementById('printLaporanReturPembelian').style.display = "block";
        var printContents = document.getElementById(divName).innerHTML;
        var originalContents = document.body.innerHTML;
        document.body.innerHTML = printContents;
        window.print();
        document.body.innerHTML = originalContents;
        document.getElementById('printLaporanReturPembelian').style.display = "none";
    }
</script>
@endsection
